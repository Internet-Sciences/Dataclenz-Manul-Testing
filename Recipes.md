...
|--------------|--------------|---------------|------------|-----------------|------------|--------|--------|
| TC_SOURCE_001 | User is logged in | Sources page displayed | Navigate to Sources page | Sources page should load successfully with Filters, Create Source panel, and Sources list | | | |
